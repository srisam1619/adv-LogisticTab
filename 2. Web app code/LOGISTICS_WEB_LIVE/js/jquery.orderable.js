...
+function ($) {
  $.fn.orderable = function (opts) {
    ...
    function mouseUp(event) {
      ...
      var movingUnitX = movingUnitPosition.left + 210;
      var movingUnitTop = movingUnitPosition.top-200;
    ...
    function calculateHoveredUnits() {
      ...
      var movingUnitX = movingUnitPosition.left + 80; //Make sure its not a border or something
      var movingUnitTop = movingUnitPosition.top - 80;
      var unitBefore = unitFromPoint(movingUnitX, movingUnitTop);
